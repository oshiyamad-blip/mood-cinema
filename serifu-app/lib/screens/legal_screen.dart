...
4. 広告について
本アプリは無料で提供するため、ホーム画面下部に小さなバナー広告を表示します（練習画面には広告を表示しません）。広告の配信には Google AdMob を使用しており、広告識別子等が Google に送信されることがあります。台本データ・練習内容が広告のために送信されることはありません。

5. データの保存と削除
台本・設定はすべて端末内に保存されます。アプリを削除すると全データが消去されます。Web版（お試し版）ではブラウザ内（localStorage）にのみ保存され、閲覧データの削除で消去されます。サーバへの送信はありません。
