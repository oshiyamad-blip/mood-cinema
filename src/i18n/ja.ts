export const ja = {
  ...
  gyaku: {
    ...
    description:
      '映画を観ながらシーンの切れ目を打刻して、そのまま箱書きに落とす脚本の勉強ツール。尺の位置から幕（三幕構成・起承転結）を自動で割り当てます。',
    heading: '逆ハコ',
    lede: '映画を観ながら、シーンの切れ目でボタンを押すだけ。打刻した時間つきで箱書きに起こし、構成を丸ごと分解します。',
    ...
    fwd10: '10秒進める',
    capture: '＋ ここでシーン',
    captureHint: 'スペースキーでも打刻できます',
    empty: 'まだ打刻がありません。シーンが切り替わったらボタンを押してください。',
