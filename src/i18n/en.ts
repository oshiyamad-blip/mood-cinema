export const en = {
  ...
  gyaku: {
    ...
    description:
      'Study screen structure by stamping each scene change while you watch, turning a film into a timecoded beat sheet. Acts are assigned automatically from where each scene falls in the runtime.',
    heading: 'Reverse Outline',
    lede: 'Watch a film and tap once at every scene change. Each beat is stamped with its timecode, so you end up with the whole structure broken down.',
    ...
    captureHint: 'Space bar works too',
    empty: 'No beats yet. Tap the button whenever the scene changes.',
